...
- **Обработка файлов**: python-magic, Pillow для валидации и обработки загруженных файлов
...
- **Редактор текста**: TipTap для форматирования текста заявок
- **Загрузка файлов**: react-dropzone для управления загрузкой файлов
